...
M2_SPLIT_RELATIVE_PATH = Path(
    "final_v0/M2_data_manifest_and_evaluation_protocol/" "splits/frailty3_future_corrected_sgkf5_v2.json"
)
...
def load_m2_frozen_registry(repository_root: str | Path) -> dict[str, Any]:
    ...
    return load_frozen_memberships(Path(repository_root).resolve() / M2_SPLIT_RELATIVE_PATH)
