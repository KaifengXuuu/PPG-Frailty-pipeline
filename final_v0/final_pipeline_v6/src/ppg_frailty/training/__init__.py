...
Stable interfaces enforce frozen outer-fold membership, epoch selection without outer labels,
hierarchical aggregation, single-factor ablations and integrity-checked deployment bundles for CLI/tests.
"""
