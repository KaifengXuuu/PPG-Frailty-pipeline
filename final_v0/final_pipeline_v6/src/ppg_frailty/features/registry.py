"""Frozen ten-field feature registry and explicit-validity model encoding.
...
The public builder combines registered groups into a content-addressed FeatureVectorV1 allowlist
and implements a 146-channel, variable-K window-only matrix. Technical fields and unknown
predictors are rejected rather than silently appended.
"""
...
class FeatureDefinition:
    """Ten required fields plus route/group."""
    ...
    def validate(self) -> None:
        """Reject empty fields and unknown routes."""
...
class FeatureRegistry:
    """Content-addressed frozen feature registry."""
...
def _hash_definitions(definitions: Sequence[FeatureDefinition]) -> str:
    """Hash definitions using canonical JSON."""
...
def _definition(
    ...
    *,
    ...
    """Construct one complete definition."""
...
def default_registry() -> FeatureRegistry:
    """Build the default complete allowlist."""
...
def summarize_engineering(
    ...
    """Aggregate by mean/population SD."""
...
def build_feature_vector(
    ...
    *,
    ...
    """Build predictors in the selected registry order.

    Missing slots remain NaN/false; unknown predictors, including technical fields, fail.
