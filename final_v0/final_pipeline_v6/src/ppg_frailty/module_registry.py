"""V2 module registry and strict adapters."""
...
ARTIFACT_MODULES = _modules(
    'artifact', 'artifacts',
    ('identity', 'ppg_frailty.artifacts.identity.IdentityReducer', ('raw', 'feature_vector', 'feature_matrix', 'fusion'),
     'direct_control', 'exact no-op; morphology remains eligible', ()),
    ('nlms_imu_anc', 'ppg_frailty.artifacts.nlms.NlmsReducer',
     ...
     ()),
    ('ssa_decomposition', 'ppg_frailty.artifacts.decomposition.SsaReducer',
    ...
    ('pca_bss', 'ppg_frailty.artifacts.bss.PcaBssReducer',
     ...
     ()),
    ('fastica_bss', 'ppg_frailty.artifacts.bss.FastIcaBssReducer',
    ...
    ('ceemd_lite_nlms_legacy', 'ppg_frailty.artifacts.legacy.CeemdLiteNlmsLegacyReducer',
     ...
     ()),
    ('dwt_a2_legacy', 'ppg_frailty.artifacts.legacy.DwtA2LegacyReducer',
     ('raw', 'feature_vector', 'feature_matrix', 'fusion'), 'comparison_rate_only',
...
COMPARISON_PROFILE_MODULES = _modules(
    ...
    ('epoch_15_ablation', 'ppg_frailty.training.trainer.TrainingConfig',
     ('raw', 'feature_matrix', 'fusion'), 'registered_not_run', 'single factor from default fixed epoch 10', ()),
    ('direct_filter_0p5_to_5hz_ablation', 'ppg_frailty.signal.preprocess.build_signal_views',
     ('raw', 'feature_vector', 'feature_matrix',
      'fusion'), 'registered_not_run', 'only named direct-filter ablation from 0.2 to 8 Hz reference', ()),
    ('imu_lpf_0p3hz_ablation', 'ppg_frailty.signal.imu.preprocess_imu',
     ('raw', 'feature_vector', 'feature_matrix',
...
MODEL_MODULES = _modules(
    ...
    ('InceptionTimeFull', 'ppg_frailty.models.inception.InceptionTimeSingleNetwork',
     ('raw', ), 'single_network', 'full single network, not five-member ensemble', ('torch', )),
    ('InceptionTimeSmall', 'ppg_frailty.models.inception.InceptionTimeSingleNetwork',
     ('raw', ), 'single_network', 'small single network', ('torch', )),
    ('InceptionTimeMatrix', 'ppg_frailty.models.inception.InceptionTimeSingleNetwork',
    ...
    ('InceptionTimeFullFiveMemberEnsemble',
     'ppg_frailty.models.inception.InceptionTimeFiveMemberProbabilityEnsemble',
    ...
    ('InceptionTimeMatrixFiveMemberEnsemble',
     ...
     ('torch', )), ('LogisticRegressionL2', 'ppg_frailty.models.feature_baselines.FeatureVectorBaseline',
                    ('feature_vector', ), 'reference', 'fold-local imputer and scaler',
                    ()), ('RBFSVM', 'ppg_frailty.models.feature_baselines.FeatureVectorBaseline',
                          ('feature_vector', ), 'reference', 'fold-local imputer and scaler',
                          ()), ('ExtraTrees', 'ppg_frailty.models.feature_baselines.FeatureVectorBaseline',
    ...
    ('ShapeFormerChannelSpecificScalarDistanceAblation', 'ppg_frailty.models.shapeformer.ExperimentalShapeFormer',
     ...
     ('torch', )),
    ('ShapeFormerEffectSizeFixedV1', 'ppg_frailty.models.shapeformer.ExperimentalShapeFormer',
    ...
    ('ShapeFormerLegacyEffectSizePort', 'ppg_frailty.models.shapeformer_legacy.LegacyEffectSizeShapeFormer',
     ...
     ('torch', )), ('FileBagFusionCompact', 'ppg_frailty.models.fusion.FileBagFusionClassifier',
                    ('fusion', ), 'reference', 'file-level concatenation once',
                    ('torch', )), ('FileBagFusionInception', 'ppg_frailty.models.fusion.FileBagFusionClassifier',
                                   ('fusion', ), 'reference', 'file-level concatenation once', ('torch', )),
    ('FileBagFusion', 'ppg_frailty.models.fusion.FileBagFusionClassifier',
...
_REPORTER_ROWS = (
    ...
    (('model', 'ShapeFormerEffectSizeFixedV1'), 'shapeformer_model_v1', 'extension',
     ...
     'Project implementation: src/ppg_frailty/models/shapeformer.py; no PISD-equivalence claim'),
    ...
    (('model', 'FileBagFusionCompact'), 'file_bag_fusion_model_v1', 'extension',
     ...
     'Project implementation: src/ppg_frailty/models/fusion.py'),
...
def list_modules(family: str = 'all') -> list[dict[str, Any]]:
    """Export modules in stable order."""
...
def registry_sha256() -> str:
    """Hash the complete registry identity."""
...
def resolve_artifact_config(section: Mapping[str, Any]) -> dict[str, Any]:
    """Validate and resolve an artifact section."""
    data = dict(section)
