"""Outer-train-only IMU scaling for raw/fusion.
...
RED/IR already follow the selected window strategy. Fit six IMU axes only on declared
outer-training participants, hashing their roster; reject any OOF fitting.
"""
...
class FoldImuChannelTransform:
    """Hash-bound six-axis fold transform."""
...
def fit_fold_imu_channel_transform(
    ...
    *,
    ...
    """Fit six IMU axes on declared train rows."""
...
def transform_raw_windows_imu(
    ...
    """Apply artifact and bind provenance."""
