...
def run_acceptance(
    *,
    ...
    raise AcceptanceFailure(
        "copied V1 acceptance harness is disabled in final_pipeline_v2; "
        "use tools/validate_v2.py and the safe smoke suite until a V2 acceptance gate is implemented"
    )
