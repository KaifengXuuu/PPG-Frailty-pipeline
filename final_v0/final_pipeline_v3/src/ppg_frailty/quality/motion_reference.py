...
def run_formal_internal_motion_reference(
    ...
    *,
    ...
    scientific_gate = establish_motion_scientific_gate(repository)
    config = RollPitchEkfConfig()
    ...
    return _run_internal_motion_oof_impl(
        ...
        formal_scientific_gate=scientific_gate,
...
def run_formal_ptt_motion_reference(
    ...
    *,
    ...
    internal_evidence, _ = load_motion_internal_evidence(
        internal_evidence_path,
        expected_sha256=expected_internal_evidence_sha256,
    )
    require_archived_gate_matches_session(
        internal_evidence.get("scientific_execution_gate"),
        scientific_gate,
