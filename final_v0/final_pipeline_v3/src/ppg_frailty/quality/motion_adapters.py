...
class FormalMotionRuntime:
    """Runtime model plus the fold-local all-nine-channel IMU transform."""
...
def _training_arrays(
    ...
    if values.shape[1:] != (11, MOTION_WINDOW_SAMPLES):
        raise ValueError("formal motion fit input must be windows-by-11-by-3200")
