...
class CanonicalFacadeTests(unittest.TestCase):
    ...
    def test_all_five_materialized_v2_configs_preflight(self) -> None:
        """五份正式 V2 配置只读通过 preflight / All five V2 configs pass."""
    ...
    def test_window_adapter_reuses_the_data_windowplan_class(self) -> None:
        ...
        config = load_config(ROOT / "configs" / "reference_static_line_a_v2.yaml").to_dict()
