...
The waveform classification method serves as a simple reference, users can use other classification schemes on the synchronized wrist and finger PPG data.
