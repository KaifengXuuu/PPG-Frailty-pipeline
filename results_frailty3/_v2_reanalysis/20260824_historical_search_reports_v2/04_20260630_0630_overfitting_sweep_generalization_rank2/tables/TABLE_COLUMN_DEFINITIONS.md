...
- **sqi_mode** (`sqi_mode`): Persisted source-table value for `sqi_mode`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **aggregation** (`aggregation`): Persisted source-table value for `aggregation`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **manual_features** (`manual_features`): Persisted source-table value for `manual_features`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **loss_type** (`loss_type`): Persisted source-table value for `loss_type`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **class_weight_mode** (`class_weight_mode`): Persisted source-table value for `class_weight_mode`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **window_sampler** (`window_sampler`): Persisted source-table value for `window_sampler`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **windows_per_subject_per_epoch** (`windows_per_subject_per_epoch`): Persisted source-table value for `windows_per_subject_per_epoch`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **train_overlap_pct** (`train_overlap_pct`): Persisted source-table value for `train_overlap_pct`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
...
- **reference_source** (`reference_source`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
- **reference_source_config_id** (`reference_source_config_id`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
...
- **mean_window_sqi** (`mean_window_sqi`): Arithmetic mean of the reported statistic over the table's declared units Formula: `mean = (1/n) * sum_i x_i`
- **n_file_aggregation_windows** (`n_file_aggregation_windows`): Number of units satisfying the column's stated inclusion condition. Formula: `count = sum_i 1[unit i satisfies the stated condition]`
- **n_subject_aggregation_windows** (`n_subject_aggregation_windows`): Number of units satisfying the column's stated inclusion condition. Formula: `count = sum_i 1[unit i satisfies the stated condition]`
- **n_train_samples_per_epoch** (`n_train_samples_per_epoch`): Number of units satisfying the column's stated inclusion condition. Formula: `count = sum_i 1[unit i satisfies the stated condition]`
...
- **quality_route_bundle** (`quality_route_bundle`): Persisted source-table value for `quality_route_bundle`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **sampling_policy** (`sampling_policy`): Persisted source-table value for `sampling_policy`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
...
- **eval_protocol** (`eval_protocol`): Persisted source-table value for `eval_protocol`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **n_splits** (`n_splits`): Number of units satisfying the column's stated inclusion condition. Formula: `count = sum_i 1[unit i satisfies the stated condition]`
- **report_config__aggregation** (`report_config__aggregation`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
- **report_config__class_weight_beta** (`report_config__class_weight_beta`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
- **report_config__class_weight_mode** (`report_config__class_weight_mode`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
...
- **report_config__focal_gamma** (`report_config__focal_gamma`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
...
- **report_config__loss_type** (`report_config__loss_type`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
- **report_config__manual_features** (`report_config__manual_features`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
...
- **report_config__sqi_mode** (`report_config__sqi_mode`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
...
- **report_config__train_overlap_pct** (`report_config__train_overlap_pct`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
...
- **report_config__window_sampler** (`report_config__window_sampler`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
- **report_config__windows_per_subject_per_epoch** (`report_config__windows_per_subject_per_epoch`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
...
- **table** (`table`): Persisted source-table value for `table`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
...
## `generalization_matched_marginal_delta_summary`
...
- **parameter** (`parameter`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
- **reference_value** (`reference_value`): Direct identifier, provenance, configuration, grouping, or status value. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
- **candidate_value** (`candidate_value`): Persisted source-table value for `candidate_value`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
...
- **aggregation_before_contrast** (`aggregation_before_contrast`): Persisted source-table value for `aggregation_before_contrast`; producer-specific semantics are not reinterpreted by the shared table renderer. Formula: `N/A — direct persisted/source-defined value; the table renderer applies no additional arithmetic.`
- **balanced_accuracy_delta_n_repeats** (`balanced_accuracy_delta_n_repeats`): Paired candidate-minus-reference difference in Macro-average recall across the K declared classes. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **balanced_accuracy_delta_mean** (`balanced_accuracy_delta_mean`): Paired candidate-minus-reference difference in Macro-average recall across the K declared classes. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **balanced_accuracy_delta_sample_sd** (`balanced_accuracy_delta_sample_sd`): Paired candidate-minus-reference difference in Macro-average recall across the K declared classes. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **balanced_accuracy_delta_repeat_t_ci95_low** (`balanced_accuracy_delta_repeat_t_ci95_low`): Paired candidate-minus-reference difference in Macro-average recall across the K declared classes. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **balanced_accuracy_delta_repeat_t_ci95_high** (`balanced_accuracy_delta_repeat_t_ci95_high`): Paired candidate-minus-reference difference in Macro-average recall across the K declared classes. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **balanced_accuracy_delta_repeat_t_ci95_method** (`balanced_accuracy_delta_repeat_t_ci95_method`): Direct method, applicability, reason, metric-roster, or cluster-unit provenance for the reported statistic. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
- **macro_f1_delta_n_repeats** (`macro_f1_delta_n_repeats`): Paired candidate-minus-reference difference in Unweighted mean of the K class-specific F1 scores. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **macro_f1_delta_mean** (`macro_f1_delta_mean`): Paired candidate-minus-reference difference in Unweighted mean of the K class-specific F1 scores. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **macro_f1_delta_sample_sd** (`macro_f1_delta_sample_sd`): Paired candidate-minus-reference difference in Unweighted mean of the K class-specific F1 scores. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **macro_f1_delta_repeat_t_ci95_low** (`macro_f1_delta_repeat_t_ci95_low`): Paired candidate-minus-reference difference in Unweighted mean of the K class-specific F1 scores. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **macro_f1_delta_repeat_t_ci95_high** (`macro_f1_delta_repeat_t_ci95_high`): Paired candidate-minus-reference difference in Unweighted mean of the K class-specific F1 scores. Formula: `delta = metric_candidate - metric_reference on the declared matched unit`
- **macro_f1_delta_repeat_t_ci95_method** (`macro_f1_delta_repeat_t_ci95_method`): Direct method, applicability, reason, metric-roster, or cluster-unit provenance for the reported statistic. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
...
- **formal_v2_inference_applicability** (`formal_v2_inference_applicability`): Direct method, applicability, reason, metric-roster, or cluster-unit provenance for the reported statistic. Formula: `N/A — identifier, provenance, configuration, status, or other non-arithmetic field.`
...
## `generalization_matched_marginal_repeat_deltas`
...
- **reference_config_count** (`reference_config_count`): Number of units satisfying the column's stated inclusion condition. Formula: `count = sum_i 1[unit i satisfies the stated condition]`
- **candidate_config_count** (`candidate_config_count`): Number of units satisfying the column's stated inclusion condition. Formula: `count = sum_i 1[unit i satisfies the stated condition]`
...
## `plot_02_model_all_archived_config_repeats`
...
## `plot_03_cnn_epochs_all_archived_config_repeats`
...
## `plot_04_regularization_bundle_all_archived_config_repeats`
...
## `plot_05_quality_route_bundle_all_archived_config_repeats`
...
## `plot_06_sampling_policy_all_archived_config_repeats`
...
## `plot_07_train_overlap_pct_all_archived_config_repeats`
...
## `plot_08_stage1_regularization_value_all_archived_config_repeats`
