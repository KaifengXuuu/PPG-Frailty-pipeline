"""Cross-module types and scientific invariants."""
...
class QualityState(str, Enum):
    """Endpoint quality status; not_applicable is distinct from pass/fail."""
...
class ManifestRow:
    """Frozen description of one recording."""
...
@dataclass
class SignalViews:
    """Amplitude-preserving direct and rate-only analysis signal views."""
    ...
    def validate(self) -> None:
        """Validate alignment and route semantics."""
...
class QualityEndpoint:
    """One endpoint-specific quality result."""
...
@dataclass(frozen=True)
class QualityResult:
    """Separate endpoint SQI contract."""
...
@dataclass(frozen=True)
class PulseResult:
    """Event, interval, and adjacency contract."""
...
class FeatureVectorV1:
    """Complete ordered file-level predictor."""
...
class EngineeringFeatureSequence:
    """Chronological engineering descriptors."""
...
class OrderedFeatureMatrixV1:
    """One D-by-K matrix per recording."""
...
class ArtifactReductionResult:
    """Common artifact-reducer result."""
...
class PredictionBundle:
    """Hierarchical predictions with coverage."""
...
def to_strict_json_value(value: Any) -> Any:
    """Convert recursively to strict JSON, preserving nonfinite values as null."""
