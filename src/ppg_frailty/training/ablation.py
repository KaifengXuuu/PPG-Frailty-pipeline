"""One-factor ablation and paired-comparison API."""
...
def run_ablation_matrix(
    ...
    Use the caller runner for baseline and strict single-factor cases, including CLI module
    quantification tests; never change folds, seeds or membership.
    """
...
def paired_subject_deltas(reference: Mapping[str, float], candidate: Mapping[str, float]) -> PairedComparison:
    """Compare identical subject keys only."""
