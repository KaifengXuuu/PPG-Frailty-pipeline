"""Strict V2 config and decision profiles."""
...
def canonical_json_bytes(value: Any) -> bytes:
    """Render canonical strict JSON bytes."""
...
def validate_config_payload(payload: Mapping[str, Any], *, allow_legacy: bool = False) -> dict[str, Any]:
    """Validate a formal V2 or explicit legacy config."""
...
def load_config(path: str | Path, *, allow_legacy: bool = False) -> PipelineConfig:
    """Load formal V2 or explicit legacy V1."""
    source = Path(path)
