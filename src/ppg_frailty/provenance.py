"""Hashing, atomic writes and evidence of fold-local fitting."""
...
def atomic_write_json(path: str | Path, value: Any, *, root: str | Path) -> None:
    """Atomically write inside a root."""
...
def assert_training_only(
    ...
    """Prove fit membership is train-only."""
...
class FittedArtifactProvenance:
    """Identity of any fold-fitted object."""
...
def runtime_environment() -> dict[str, Any]:
    """Capture the reproducible runtime environment."""
